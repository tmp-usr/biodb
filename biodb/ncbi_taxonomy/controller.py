...
class Controller(object):
    ...
    def __init__(self, biodb_selector, lineage_types_file_path="" ):
        ...
        if lineage_types_file_path != "":
            br= BatchReader(1000, open(lineage_types_file_path).readlines())
            for chunk in br:
                ...
                for line in chunk:
                    ...
                    feature= biodb_selector.getFeatureByID(tax_id)
...
Controller(s, lineage_types_file_path)
